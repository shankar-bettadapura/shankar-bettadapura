...
| 6 | [APT TTP Mapper](https://github.com/shankar-bettadapura/apt-ttp-mapper) | Python tool that extracts and maps adversary TTPs from threat intelligence reports to the MITRE ATT&CK Enterprise framework, tested against CISA Advisory AA26-097A on Iranian ICS targeting | Python, MITRE ATT&CK | April 2026 |
